...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2017 a las 03:02:08
...
INSERT INTO `persona` (`id`, `nombre`, `clave`, `id_localidad`) VALUES
(5, 'user2', '1234', 1),
(6, 'otro', '1234', 2),
(7, 'user4', '1234', 3),
(10, 'user5', '1234', 3),
...
('root', '[{"db":"utn","table":"envios"},{"db":"utn","table":"productos"},{"db":"utn","table":"provedores"},{"db":"persona","table":"persona"},{"db":"utn","table":"Envios"},{"db":"utn","table":"Productos"},{"db":"UTN","table":"Provedores"},{"db":"persona","table":"localidades"}]');
...
('root', 'persona', 'persona', '[]', '2017-10-02 22:34:51');
...
('root', '2016-12-08 00:37:17', '{"lang":"es","collation_connection":"utf8mb4_unicode_ci"}');
...
-- Base de datos: `utn`
--
CREATE DATABASE IF NOT EXISTS `utn` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `utn`;
...
(100, 'Perez', 'Peron876', 'Quilmes'),
(101, 'Gimenez', 'Mitre750', 'Avellaneda'),
(102, 'Perez', 'Boedo634', 'Bernal');
